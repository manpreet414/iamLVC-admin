...
var BaseService = (function () {
    function BaseService(http, suffix) {
        this.url = new Map;
        this.http = http;
        this.url.set('socket', __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].config.SOCKET_URL);
        this.url.set('base', __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].config.BASE_URL);
        this.url.set('api', __WEBPACK_IMPORTED_MODULE_1__environments_environment__["a" /* environment */].config.API_URL);
        this.url.set('suffix', suffix);
    }
    BaseService.prototype.authToken = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["a" /* Headers */]({ 'Authorization': localStorage.getItem('token') });
        return new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* RequestOptions */]({ headers: headers });
    };
    BaseService.prototype.getHeader = function (language) {
    ...
    BaseService.prototype.getUrl = function (suffix) {
        return this.url.get('api') + (suffix ? suffix : this.url.get('suffix'));
    };
    BaseService.prototype.getItems = function (language, suffix) {
    ...
    BaseService.prototype.getXItems = function (obj, language, suffix) {
        if (suffix === void 0) { suffix = null; }
    ...
    BaseService.prototype.getItem = function (id, language, suffix) {
        if (suffix === void 0) { suffix = null; }
        return this.http.get(this.getUrl(suffix) + '/' + id, this.getHeader(language))
            .toPromise().then(function (response) { return response.json(); });
    };
    BaseService.prototype.addItem = function (obj, language, suffix) {
        var _this = this;
        if (suffix === void 0) { suffix = null; }
    ...
    BaseService.prototype.updateItem = function (id, obj, language, suffix) {
        var _this = this;
        if (suffix === void 0) { suffix = null; }
    ...
    BaseService.prototype.removeItem = function (obj, language, suffix) {
        var _this = this;
        if (suffix === void 0) { suffix = null; }
        var url = this.getUrl(suffix) + '/' + obj._id + '/' + obj.is_deleted;
        return this.http.get(url, this.getHeader(language))
            .toPromise().then(function (response) { return response.json(); })
            .catch(function (data) { return _this.handleError(data); });
    };
    BaseService.prototype.deleteItem = function (obj, language, suffix) {
        var _this = this;
        if (suffix === void 0) { suffix = null; }
    ...
    BaseService.prototype.toggleStatus = function (obj, language, suffix) {
        var _this = this;
        if (suffix === void 0) { suffix = null; }
        var url = this.getUrl(suffix) + '/' + obj._id;
        return this.http.put(url, obj, this.getHeader(language))
            .toPromise().then(function (response) { return response.json(); })
            .catch(function (data) { return _this.handleError(data); });
    };
    BaseService.prototype.getCountries = function (language) {
        return this.getItems(language, 'countries');
    };
    BaseService.prototype.getRoles = function (code) {
