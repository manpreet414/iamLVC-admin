...
var FormComponent = (function (_super) {
    ...
    FormComponent.prototype.createItem = function () {
        var _this = this;
        this.busy = this.klassService.addItem(this.item, this.language, 'intervension').then(function (res) {
            if (!res)
                return true;
            _this.toastr.success('.', 'Intervension Created.', { timeOut: 3000, });
            _this.item = res;
            _this.router.navigate(['/intervension']);
        });
    };
    FormComponent.prototype.updateItem = function () {
        var _this = this;
        this.busy = this.klassService.updateItem(this.itemID, this.item, this.language, 'intervension').then(function (res) {
            if (!res)
                return true;
            _this.toastr.success('.', 'Intervension Updated.', { timeOut: 3000, });
            _this.router.navigate(['/intervension']);
        });
    };
...
var IntervensionService = (function (_super) {
    ...
    function IntervensionService(_router, http) {
        var _this = _super.call(this, http, 'intervension') || this;
...
var ListingComponent = (function (_super) {
    ...
    ListingComponent.prototype.getItems = function () {
        var _this = this;
        this.items = [];
        this.busy = this.klassService.getItems(this.language, 'intervension').then(function (res) {
            if (!res)
                return true;
    ...
    ListingComponent.prototype.removeItem = function () {
        ...
        this.busy = this.klassService.removeItem(this.item, this.language, 'intervension').then(function (res) {
            if (!res)
                return true;
            _this.item = null;
            _this.getItems();
    ...
    ListingComponent.prototype.toggleStatus = function (_item) {
        this.busy = this.klassService.toggleStatus(_item, this.language, 'intervension').then(function (res) {
            if (!res)
                return true;
        });
    };
