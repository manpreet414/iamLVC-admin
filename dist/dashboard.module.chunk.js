...
var DashboardComponent = (function () {
    function DashboardComponent(klassService) {
        this.klassService = klassService;
        this.isAdmin = false;
        this.language = 'en';
    }
    DashboardComponent.prototype.ngOnInit = function () { };
    DashboardComponent.prototype.formatDate = function (dateTime, time) {
        var date = dateTime.split('T')[0];
        if (time) {
            var time_1 = dateTime.split('T')[1];
            return __WEBPACK_IMPORTED_MODULE_2_moment__(date).format('MMM DD, YYYY') + ' ' + __WEBPACK_IMPORTED_MODULE_2_moment__(time_1, ["HH:mm:ss"]).format("hh:mm A");
        }
        else {
            return __WEBPACK_IMPORTED_MODULE_2_moment__(date).format('MMM DD, YYYY');
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_app_shared_module__ = __webpack_require__("../../../../../src/app/shared/app-shared.module.ts");
...
var GOOGLE_DISTANCE_API_KEY = "AIzaSyB84_b3sz-C67ERkmEnQXAu_EglmB-AG1g";
...
DashboardModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__shared_app_shared_module__["a" /* AppSharedModule */],
...
var DashboardService = (function (_super) {
    ...
    function DashboardService(_router, http) {
        var _this = _super.call(this, http, 'dashboard') || this;
